...
public class ConsultationSchema extends RendezVousSchema implements Serializable {
    ...
    public ConsultationSchema(LocalDate date, LocalTime heure, String nom,String prenom,int age) {
        this.date = date;
        this.heure = heure;
        this.patient = (age <= 13) ? new EnfantSchema(nom,prenom,age) : new AdultSchema(nom, prenom, age);
    }
}
